<template>
    <div class="body">
        <el-form :model="mdl" ref="ruleForm" label-width="130px">
            ...
            <el-form-item :label="$i18n.t('AGENT_LEVEL')" :error="errors.agent_level">
                <el-input-number v-model="mdl.agent_level" :placeholder="$i18n.t('PLEASE_INPUT', { value: $i18n.t('AGENT_LEVEL') })" :min="0"></el-input-number>
            </el-form-item>
