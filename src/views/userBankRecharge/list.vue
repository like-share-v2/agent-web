    ...
    <div>
        ...
        <div class="table-body">
            ...
            <el-table border style="width: 100%;" stripe :data="data" v-loading="loading">
                ...
                <el-table-column align="center" prop="name" :label="$i18n.t('BANK_RECHARGE_NAME')" :min-width="100"></el-table-column>
                <el-table-column align="center" prop="bank" :label="$i18n.t('BANK_RECHARGE_BANK')" :min-width="100"></el-table-column>
                <el-table-column align="center" prop="amount" :label="$i18n.t('BANK_RECHARGE_AMOUNT')" :min-width="100"></el-table-column>
...
<script>
    ...
    import FormModal from '@/components/userBankRecharge/FormModal'
    import { getUserBankRechargeList } from '@/api/userBankRecharge'
    ...
    export default {
        ...
        methods: {
            ...
            fetch () {
                this.loading = true
                getUserBankRechargeList({ ...this.params, page: this.page.currentPage, perPage: this.page.perPage }).then((res) => {
