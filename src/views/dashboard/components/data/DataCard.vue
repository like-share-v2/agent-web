<template>
    <div :style="{height:height,width:width}">
        <el-card class="box-card" shadow="never" style="height: 95%">
            <div class="block">
                <el-date-picker
                    v-model="date"
                    type="datetimerange"
                ...
                <el-input v-model="userId" style="width: 120px;padding-left: 5px;padding-right: 5px" prefix-icon="el-icon-user"></el-input>
        ...
        >
            ...
            <data-table :time="date"  :handle-close-dialog="handleCloseDialog" :type="type" :userId="userId"></data-table>
        </el-dialog>
    </div>
</template>
    ...
    export default {
        ...
        methods: {
            ...
            fetch () {
                ...
                get({ time: this.date, user_id: this.userId }).then((res) => {
