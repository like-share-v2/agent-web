...
<!--                <el-table-column type="selection" align="center" prop="id" label="ID" :width="50" ></el-table-column>-->
                ...
                <el-table-column align="center" prop="parent_id" :label="$i18n.t('PARENT_ID')" :min-width="100"></el-table-column>
                ...
                <el-table-column align="center" prop="balance" :label="$i18n.t('BALANCE')" :min-width="100"></el-table-column>
...
<script>
    ...
    import { getMember, enableMember, disableMember, setUpAgent, cancelAgent } from '@/api/member'
    ...
    export default {
        name: 'user',
        components: { SearchForm, RechargeFormModal, BalanceFormModal, Team, FormModal },
        data () {
            return {
                PAGES_SIZE,
                params: {},
