    ...
    <div class="body">
        <el-form :model="mdl" ref="ruleForm" label-width="150px">
            <el-form-item :label="$i18n.t('MEMBER_LEVEL')" required :error="errors.level">
                <el-input-number v-model="mdl.level" controls-position="right" :placeholder="$i18n.t('PLEASE_INPUT', { value: $i18n.t('MEMBER_LEVEL') })" style="width: 200px"></el-input-number>
            </el-form-item>
            ...
            <el-form-item :label="$i18n.t('LEVEL_PRICE')" required :error="errors.price">
                <el-input-number v-model="mdl.price" controls-position="right" :min="0" :placeholder="$i18n.t('PLEASE_INPUT', { value: $i18n.t('LEVEL_PRICE') })" :precision="2" style="width: 200px"></el-input-number> {{ $i18n.t('YUAN') }}
            </el-form-item>
            ...
            <el-form-item :label="$i18n.t('RECHARGE_P_ONE_REBATE')" required :error="errors.recharge_p_one_rebate">
                <el-input-number v-model="mdl.recharge_p_one_rebate" controls-position="right" :min="0" :placeholder="$i18n.t('PLEASE_INPUT', { value: $i18n.t('RECHARGE_P_ONE_REBATE') })" :precision="2" style="width: 200px"></el-input-number> {{ $i18n.t('YUAN') }}
            </el-form-item>
            <el-form-item :label="$i18n.t('RECHARGE_P_TWO_REBATE')" required :error="errors.recharge_p_two_rebate">
                <el-input-number v-model="mdl.recharge_p_two_rebate" controls-position="right" :min="0" :placeholder="$i18n.t('PLEASE_INPUT', { value: $i18n.t('RECHARGE_P_TWO_REBATE') })" :precision="2" style="width: 200px"></el-input-number> {{ $i18n.t('YUAN') }}
            </el-form-item>
            <el-form-item :label="$i18n.t('RECHARGE_P_THREE_REBATE')" required :error="errors.recharge_p_three_rebate">
                <el-input-number v-model="mdl.recharge_p_three_rebate" controls-position="right" :min="0" :placeholder="$i18n.t('PLEASE_INPUT', { value: $i18n.t('RECHARGE_P_THREE_REBATE') })" :precision="2" style="width: 200px"></el-input-number> {{ $i18n.t('YUAN') }}
            </el-form-item>
