...
<!--            <line-chart :chart-data="lineChartData" :loading="lineChartLoading"/>-->
            ...
            <data-card :manual-recharge-data="manualRechargeData" :loading="dataLoading"/>
        </el-row>
        ...
        <el-row :gutter="32">
            ...
            <el-col :xs="24" :sm="24" :lg="8">
                <div class="chart-wrapper">
                    <user-manual-recharge-data-card :manual-recharge-data="manualRechargeData" :loading="dataLoading"/>
                </div>
            </el-col>
            <el-col :xs="24" :sm="24" :lg="8">
                <div class="chart-wrapper">
...
<script>
    ...
    import UserManualRechargeDataCard from '@/views/dashboard/components/dataCard/UserManualRechargeDataCard'
    ...
    export default {
        ...
        created () {
            ...
            getData().then((res) => {
                const { userTaskData, manualRechargeData, withdrawal_data } = res.result
                this.userTaskData = userTaskData
                this.manualRechargeData = manualRechargeData
